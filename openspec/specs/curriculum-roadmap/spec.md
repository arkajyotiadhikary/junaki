...
Define the 26-week MAANG-prep roadmap as data in `data/curriculum.json`, so `today`, `mock`, and the stats dashboard can derive the daily plan, phase/week, and progress from a single source of truth.
